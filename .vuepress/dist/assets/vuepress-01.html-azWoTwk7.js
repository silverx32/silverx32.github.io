import{_ as i,r as l,o as t,c,a as n,b as s,d as e,e as o}from"./app-YO_tD6Q0.js";const p="/assets/vuepress-01-002-LCvRZaOH.png",d="/assets/vuepress-01-001-9mq9DeUx.png",u={},r=n("h2",{id:"前期准备",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前期准备","aria-hidden":"true"},"#"),s(" 前期准备")],-1),m=n("br",null,null,-1),v={href:"https://nodejs.org/en",target:"_blank",rel:"noopener noreferrer"},b=n("s",null,"捏马，没有中文",-1),k=n("br",null,null,-1),h={href:"https://www.baidu.com/s?ie=UTF-8&wd=nodejs",target:"_blank",rel:"noopener noreferrer"},g=n("li",null,"创建文件夹",-1),_=o(`<ul><li>在本地创建一个文件夹(只要创建文件夹就行)</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token operator">&lt;</span>文件夹名<span class="token operator">&gt;</span>
